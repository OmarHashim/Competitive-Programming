/*
   Brute force all ways to split the points into groups , there is about 20000 ways
   for each group, calculate its answer separtley, first we run convex hull for the points
   then we calculate the cost of surrounding this hull with a fence, around each point on the hull 
   there will be a curve of non negative length, and a straight line connecting the curve with the curve of the following point
*/
